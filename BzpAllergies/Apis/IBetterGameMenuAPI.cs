...
public interface IBetterGameMenuApi {
	...
	/// else <c>null</c>.
	/// </summary>
	IBetterGameMenuAPI? ActiveMenu { get; }

	/// <summary>
	/// Attempt to cast the provided menu into an <see cref="IBetterGameMenuAPI"/>.
	...
	IBetterGameMenuAPI? AsMenu(IClickableMenu menu);
	...
	IBetterGameMenuAPI? TryOpenMenu(
	...
	/// the menu's constructor. As such, this is called before the new <see cref="IBetterGameMenuAPI"/>
